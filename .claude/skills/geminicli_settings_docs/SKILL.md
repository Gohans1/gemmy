---
name: geminicli_settings_docs
description: sử dụng khi user cần thay đổi file settings.json của gemini cli
---
...
The CLI automatically loads environment variables from an .env file. The loading order is:
    ...
    If not found, it searches upwards in parent directories until it finds an .env file or reaches the project root (identified by a .git folder) or the home directory.
...
Google logo For Developers logo
Terms
|
Privacy
